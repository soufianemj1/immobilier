...
<nav class="navbar">
    ...
    <section class="empty">
        <h1 class="animate__animated animate__fadeInDown">VIENS NOUS VOIR!</h1>

    </section>

    <section class="totalcontactempty">
        
            <div class="contacthead"><img src="http://localhost/mvcimmobilier/view/userfront/userimage/rdv.png" alt=""></div>
            

        
        
        
        <form action="http://localhost/mvcimmobilier/rdv/save" method="post">
